...
void solve()
{
    ...
    for(int i=0; i<n; i++)
    {
        for(int j=0; j<m; j++)
        {
            if(mat[i][j] == 0 && i - 1 >= 0 && mat[i - 1][j] == 0) consecutiveZeros++;
            if(mat[i][j] == 0 && j - 1 >= 0 && mat[i][j - 1] == 0) consecutiveZeros++;
            if(mat[i][j] == 0 && j - 1 >= 0 && i - 1 >= 0 && mat[i - 1][j - 1] == 0) consecutiveZeros++;
            if(mat[i][j] == 0 && j + 1 < m && i - 1 >= 0 && mat[i - 1][j + 1] == 0) consecutiveZeros++;
    ...
    //cout<<ones<<" "<<zeros<<" "<< consecutiveZeros<<" ";
