...
void solve()
{
    ...
    int xFactorCount = n / x;
    int yFactorCount = n / y;
    int lcmFactorCount = n / lcm;

    long long answer = 0;
    int num = n;

    int addCount = xFactorCount - lcmFactorCount;
    int subCount = yFactorCount - lcmFactorCount;

    answer += ((addCount * n) - (addCount * (addCount - 1)) / 2);
    answer -= (subCount * (subCount + 1)) / 2;
