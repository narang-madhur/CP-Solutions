...
void solve()
{
    ...
    for(int i = 0 ; i <= n ; i++)
    {
        if(i >= notEquals && (i - notEquals) % 2 == 0 && ((i - notEquals) / 2) <= (equalOnes + equalZeros))
        {
            answer += '1';
        }
        else if(i >= notEquals && (i - notEquals) % 2 == 1 && hasMiddle == 1 && ((i - notEquals) / 2) <= (equalOnes + equalZeros))
        {
            answer += '1';
        }
        else if(i == (notEquals + 1) && hasMiddle == 1)
        {
            answer += '1';
        }
        else
