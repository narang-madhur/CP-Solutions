...
void solve()
{
    ...
    for(int i = 0 ; i < n ; i++)
    {
        ...
        firstPositions.push_back(tempA[0]);
        secondPositions.push_back(tempA[1]);
    }

    sort(firstPositions.begin() , firstPositions.end());
    sort(secondPositions.begin() , secondPositions.end());

    secondPositions[0] = firstPositions[0];

    long long sum = 0;

    for(int i = 0 ; i < secondPositions.size() ; i++)
    {
        sum += secondPositions[i];
    }
